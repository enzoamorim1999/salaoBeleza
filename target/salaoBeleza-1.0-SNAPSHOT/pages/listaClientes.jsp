...
<html class="ls-theme-blue ls-window-lg ls-screen-lg ls-browser-chrome">
    <head>
        ...
        <script>
            function confirme(id) {
                var txt;
                var r = confirm("Deseja realmente excluir o funcionario?");
                if (r == true) {
                    console.log(id);
        ...
        <div class="collapse" id="navbarToggleExternalContent">
            <div class="bg-dark p-4">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand"  aria-haspopup="true" aria-expanded="false" href="listaServicos.html">Servi√ßos</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="ls-box">
        ...
        <div>
            <a href="<%= request.getContextPath() + "/cadastroCliente"%>" class="ls-btn-primary ls-ico-user ls-btn-lg">Adicionar usu·rio</a>
